...
@section('content')
    <main class="container mx-auto px-6 pt-24 pb-12">
        <div class="bg-white rounded-xl shadow-lg p-6 card animate-fade-in max-w-2xl mx-auto">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6"><i class="fas fa-plus mr-2 text-orange-600"></i>Tambah Pakan</h2>
            ...
            <form method="POST" action="{{ route('postAddPakan', ['username' => $username]) }}">
                @csrf
                <div class="mb-4">
